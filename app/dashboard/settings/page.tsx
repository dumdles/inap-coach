...
const TABS: { id: TabId; label: string; desc: string; icon: React.ReactNode }[] = [
    ...
    { id: 'goal',     label: 'Goal mode',       desc: 'Set your nutritional objective',           icon: <TargetIcon /> },
    { id: 'wing',     label: 'Wing & cohort',   desc: 'Your unit and rank',                       icon: <FlagIcon /> },
...
export default function SettingsPage() {
    ...
    const WingSection = (
        <SCard>
            <div className="grid grid-cols-2 gap-3.5">
                <Field label="Wing"><TSelect value={form.wing} onChange={v => set('wing', v)} options={WINGS} /></Field>
                <Field label="Gender"><TSelect value={form.gender} onChange={v => set('gender', v)} options={['Male', 'Female', 'Other']} /></Field>
                <Field label="Activity level"><TSelect value={form.activity_level} onChange={v => set('activity_level', v)} options={[
            ...
            <div className="mt-4 p-3 bg-[#FFFAE6] dark:bg-amber-900/20 border border-[#FFEEB2] dark:border-amber-800/40 rounded-lg text-[12px] text-[#974F0C] dark:text-amber-400">
                Wing changes may require approval from your instructor.
            </div>
        </SCard>
    )
